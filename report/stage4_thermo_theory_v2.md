...
## Files
- `outputs/stage4_prl/thermo_theory_v2/stage4_beta_by_size.csv`
- `outputs/stage4_prl/thermo_theory_v2/stage4_beta_thermo_extrapolation.csv`
- `outputs/stage4_prl/thermo_theory_v2/stage4_quantile_bound.csv`
- `outputs/stage4_prl/thermo_theory_v2/figs/fig_stage4_beta_by_size.png`
- `outputs/stage4_prl/thermo_theory_v2/figs/fig_stage4_beta_inf_forest.png`
- `outputs/stage4_prl/thermo_theory_v2/figs/fig_stage4_quantile_bound.png`
- `outputs/stage4_prl/thermo_theory_v2/stage4_summary.json`