...
- finite-size gate at max N=10 (`beta_ci_low > 0` all cells): `True`
- finite-size gate expressive-only at max N=10 (`gru,made`): `True`
...
## Files
- `outputs/stage4_prl/thermo_theory_v4/stage4_beta_by_size.csv`
- `outputs/stage4_prl/thermo_theory_v4/stage4_beta_thermo_extrapolation.csv`
- `outputs/stage4_prl/thermo_theory_v4/stage4_quantile_bound.csv`
- `outputs/stage4_prl/thermo_theory_v4/figs/fig_stage4_beta_by_size.png`
- `outputs/stage4_prl/thermo_theory_v4/figs/fig_stage4_beta_inf_forest.png`
- `outputs/stage4_prl/thermo_theory_v4/figs/fig_stage4_quantile_bound.png`
- `outputs/stage4_prl/thermo_theory_v4/stage4_summary.json`